...
- id: "CR-20260118-007"
  date: "2026-01-18"
  summary: "Removed obsolete pack-template references and reaffirmed per-achievement JSON sourcing."
  files:
    ...
    - "docs/governance/conflicts/resolutions.md"
    - "docs/governance/changes/change-records.md"
  notes: "Pack/template conflicts consolidated into the canonical achievement docs; packs removed from scope."
  ```
