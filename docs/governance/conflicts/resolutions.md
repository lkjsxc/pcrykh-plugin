...
- node: docs/governance/conflicts/resolutions.md
	...
	- C-011 — Pack templates vs per-achievement files:
		- conflict:
			- older specs required pack/template-based achievement generation
			- newer specs require one achievement per file
		- resolution:
			- packs/templates are removed
			- achievement catalog is loaded from per-achievement JSON files
